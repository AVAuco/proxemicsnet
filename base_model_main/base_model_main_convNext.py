#====================================================================
# MAIN : Train and test a BASE MODEL with ConvNext (RGB)
# ====================================================================
...
if __name__ == '__main__':
    ...
    # In adittion, we train  2 more epochs by adding validation samples to the training set
    ...
    # 9. Checkpoint training and testing
    ...
    with mirrored_strategy.scope(): 
      ...
      dd.io.save(testFile, AP)
      wandb.log({"AP_chkt": AP})

      # 10. Test model per image 
      testIdx=[]
      y_pred_img=[]
      y_test_img=[]
      for img in testImg:
